...
//     const { first_name, last_name, username, institute, current_password, new_password, confirm_password } = formData;
...
//               { label: "password", name: "new_password", type: "password" },
...
//       <main className="flex-1 max-w-full mx-auto p-6 space-y-8">
//         <header className="flex justify-between items-center bg-white p-4 rounded-lg shadow-md">
//           <img src="./Pharmanetlogo.png" alt="Logo" className="w-28 object-contain cursor-pointer" onClick={()=>router.push("/")}/>
//           <button
//             onClick={() => {
//               Swal.fire({
//                 title: "Logged Out",
...
//uest data based on whether password fields are provided
      const data = {
        first_name,
        last_name,
        username,
