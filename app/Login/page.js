          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6 relative">
              ...
              <input
                ...
                name="password"
                id="password"
                className="w-full p-4 pl-10 pr-10 border text-black border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                placeholder="Enter your password"
                value={valuedata.password}
              />
              <div
            ...
            <button
              type="submit"
              className="w-full py-3 bg-teal-700 text-white font-bold rounded-lg shadow-xl hover:bg-teal-800 transition-transform transform hover:scale-105"
            >
              Log in
            </button>
          </form>
