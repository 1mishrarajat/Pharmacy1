...
//     alert(`Delete functionality not implemented for ID: ${id}`);
//   };

//   const handleEdit = (id) => {
//     // Add edit functionality
//     alert(`Edit functionality not implemented for ID: ${id}`);
//   };
...
//                           >
//                             <td className="px-2 py-3 border">{index + 1}</td>
//                             <td className="px-2 py-3 truncate border">
//                               {item.first_name}
//                             </td>
//                             <td className="px-2 py-3 truncate border">
//                               {item.last_name}
...
//         try {
//           const response = await axios.delete(`https://dir.mripub.com/api/deleteCustomer.php?id=${id}`, {
//             headers: {
//               Authorization: `Bearer ${token}`,
//             },
//           });
...
//             setData(data.filter((item) => item.id !== id)); // Remove deleted customer from the state
//           } else {
...
//         "https://dir.mripub.com/api/showcustomers.", // API endpoint for updating customer
//         formData,
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
...
//                 </p>
//                 <p>
//                   <strong>Pin Code:</strong> {selectedCustomer.pin}
//                 </p>
//                 <p>
//                   <strong>IP Address:</strong> {selectedCustomer.ip_address}
//                 </p>
...
//       try {
//         const response = await axios.post(
//           "https://dir.mripub.com/api/showcustomers.",
//           {},
//           {
//             headers: {
//               Authorization: `Bearer ${token}`,
...
//       if (result.isConfirmed) {
//         try {
//           const response = await axios.delete(`https://dir.mripub.com/api/showcustomers.?id=${id}`, {
//             headers: {
//               Authorization: `Bearer ${token}`,
//             },
//           });
